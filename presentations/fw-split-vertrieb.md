...
- Upgrade **OX-Button** auf **OX-Label**: erneutes OTA erforderlich (explizite Entscheidung)
...
- OTA-Dashboard: Firmware für **OX-Label** oder **OX-Button** wählen und installieren
...
::: columns
:::: column
- Eine Firmware für **OX-Label** und **OX-Button**
...
| Kundenerfahrung | **OX-Label** via OTA; **OX-Button** bleibt Button | Kein OTA-Schritt beim Onboarding oder Upgrade |
...
- **Szenario B wählen wenn:** Einfacher Upgrade-Pfad **OX-Button** auf **OX-Label** und kein OTA beim Onboarding oberste Priorität
